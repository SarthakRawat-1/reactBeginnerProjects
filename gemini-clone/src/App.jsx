...
function App() {
  ...
  useEffect(() => {
    //Adds new chat when button is clicked from sidebar
    if (newChat) {
  ...
  useEffect(() => {
    if (conversationHistory.length == 1) {
      //adds new conversation in the historyArr that has all the chats
  ...
  const handleRun = async () => {
    //async function because it takes some time to fetch response from api
  ...
  return (
    <div className="App">
      ...
      <div
        className={
          conversationHistory.length === 0 ? "midContainer" : "chatContainer"
        }
      >
        {conversationHistory.length !== 0 ? (
          conversationHistory.map((convo, index = 0) => {
            if (loading && conversationHistory.length - 1 === index) {
              ...
              return (
                <div key={convoKey}>
                  <div className="chat">
                    {convo.role === "user" ? (
                      <img src={assets.user_icon} className="chatImg" alt="" />
                    ) : (
                      <img
                    ...
                    <span
                      className={
                        index % 2 !== 0 ? "chatText lighter" : "chatText"
                      }
                      ref={
                        conversationHistory.length - 1 === index
                          ? bottomRef
                          : null
                      }
                  ...
                  <div className="chat">
                    ...
                    <div
                      ...
                      ref={
                        conversationHistory.length - 1 === index
                          ? bottomRef
                          : null /* this div is for animation and this ref is to scroll to bottom automatically */
                      }
                    >
                      <hr />
                      <hr />
              ...
              //this else part is to markup the response received from API
          ...
          <>
            ...
            <div className="suggestion">
              <button
                ...
                onClick={() =>
                  setInput(
                    "Compare the differences between pickleball and tennis"
                  )
                }
              >
                <span className="sgTxt">
                  Compare the differences between pickleball and tennis
                </span>
              ...
              <button
                className="sgBtn"
                onClick={() =>
                  setInput("What is React js and what is it's importance")
                }
              >
                <span className="sgTxt">
                  What is React js and what is it's importance
                </span>
      ...
      <div className="Footer">
        ...
        <div className="info">
          ...
          <button className="infbtn">Your privacy and Gemini Apps</button>
        </div>
      </div>
    </div>
  );
